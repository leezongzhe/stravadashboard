...
This README covers the **original version**, now contained in `version_1/`. The
newer implementations are kept separately in `version_2/` and `app_version/`.
...
- Run all Version 1 setup and launch commands from the `version_1/` directory.
